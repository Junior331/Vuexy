...
export const Menu = () => {
  ...
  return (
    <S.MenuContainer mobile={isMobile}>
      {isMobile && <S.Logo src={getImage("logo")} alt="Logo do lovemonster" />}
      <S.ItemLink to="/lovemonster/account">
      ...
      <S.ContainerLink>
        ...
        <S.ItemLinkNoIcon to="">
          {isMobile && <S.Text onClick={() => logOut()}>Log out</S.Text>}
        </S.ItemLinkNoIcon>
      </S.ContainerLink>
    </S.MenuContainer>
  );
